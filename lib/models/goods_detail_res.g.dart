...
GoodsDetailRes _$GoodsDetailResFromJson(Map<String, dynamic> json) =>
    GoodsDetailRes(
...
Map<String, dynamic> _$GoodsDetailResToJson(GoodsDetailRes instance) =>
    <String, dynamic>{
...
GoodsInfo _$GoodsInfoFromJson(Map<String, dynamic> json) => GoodsInfo(
      ...
      appraiseList: (json['appraiseList'] as List<dynamic>?)
          ?.map((e) => AppraiseInfo.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
...
Map<String, dynamic> _$AppraiseInfoToJson(AppraiseInfo instance) =>
    <String, dynamic>{
...
DetailInfo _$DetailInfoFromJson(Map<String, dynamic> json) => DetailInfo(
      ...
      introductionList: (json['introductionList'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
