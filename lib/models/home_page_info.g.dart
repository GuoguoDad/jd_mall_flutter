...
HomePageInfo _$HomePageInfoFromJson(Map<String, dynamic> json) => HomePageInfo(
      bannerList: (json['bannerList'] as List<dynamic>?)?.map((e) => BannerList.fromJson(e as Map<String, dynamic>)).toList(),
      adUrl: json['adUrl'] as String?,
      nineMenuList: (json['nineMenuList'] as List<dynamic>?)?.map((e) => NineMenuList.fromJson(e as Map<String, dynamic>)).toList(),
      tabList: (json['tabList'] as List<dynamic>?)?.map((e) => TabList.fromJson(e as Map<String, dynamic>)).toList(),
    );

Map<String, dynamic> _$HomePageInfoToJson(HomePageInfo instance) => <String, dynamic>{
...
Map<String, dynamic> _$BannerListToJson(BannerList instance) => <String, dynamic>{
...
Map<String, dynamic> _$NineMenuListToJson(NineMenuList instance) => <String, dynamic>{
