...
import 'extended_primary_scroll_controller.dart';
import 'extended_scroll_configuration.dart';
import 'extended_scroll_controller.dart';
import 'package:flutter/src/widgets/scroll_delegate.dart';
import 'package:flutter/src/widgets/scroll_notification.dart';
import 'package:flutter/src/widgets/scroll_physics.dart';
import 'extended_scrollable.dart';
...
abstract class ScrollView extends StatelessWidget {
  ...
  const ScrollView({
    ...
    this.clipBehavior = Clip.hardEdge,
        ...
        physics = physics ??
            ((primary ?? false) || (primary == null && controller == null && identical(scrollDirection, Axis.vertical))
  ...
  ///
  /// A [ExtendedScrollController] serves several purposes. It can be used to control
  /// the initial scroll position (see [ExtendedScrollController.initialScrollOffset]).
  /// It can be used to control whether the scroll view should automatically
  /// save and restore its scroll position in the [PageStorage] (see
  /// [ExtendedScrollController.keepScrollOffset]). It can be used to read the current
  ...
  ///
  /// Cannot be true while a [ExtendedScrollController] is provided to `controller`,
  ...
  ///
  /// {@tool dartpad}
  /// This sample shows a [ExtendedCustomScrollView], with [Radio] buttons in the
  /// [AppBar.bottom] that change the [AxisDirection] to illustrate different
  /// configurations. The [ExtendedCustomScrollView.anchor] and [ExtendedCustomScrollView.center]
  ...
  /// [ExtendedCustomScrollView.center] key is positioned at the [ExtendedCustomScrollView.anchor].
  ///
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<ExtendedScrollController>('controller', controller, showName: false, defaultValue: null));
...
/// two [SliverList] children, and the [ExtendedCustomScrollView.center] set to the key
...
/// ## Accessibility
///
/// A [ExtendedCustomScrollView] can allow Talkback/VoiceOver to make announcements
...
/// [ExtendedCustomScrollView.slivers] property instead of the list itself, and having
...
/// [SliverGrid] or [SliverAppBar], can be put in the [ExtendedCustomScrollView.slivers]
/// list.
///
/// {@tool snippet}
///
...
///
/// The [padding] property corresponds to having a [SliverPadding] in the
/// [ExtendedCustomScrollView.slivers] property instead of the grid itself, and having
/// the [SliverGrid] instead be a child of the [SliverPadding].
///
/// Once code has been ported to use [ExtendedCustomScrollView], other slivers, such as
/// [SliverList] or [SliverAppBar], can be put in the [ExtendedCustomScrollView.slivers]
/// list.
///
/// {@tool snippet}
...
/// using a [ExtendedCustomScrollView] and a [SliverGrid].
///
