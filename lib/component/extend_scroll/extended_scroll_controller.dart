...
import 'extended_scroll_position_with_single_context.dart';
...
///    [ScrollPosition] objects with [ExtendedScrollController] objects.
...
class ExtendedScrollController extends ChangeNotifier {
  ...
  /// [ExtendedScrollController] using the [attach] method.
  ///
  ...
  /// the [ExtendedScrollController] base class calls [debugFillDescription] to collect
...
/// A [ExtendedScrollController] whose [initialScrollOffset] tracks its most recently
...
class TrackingScrollController extends ExtendedScrollController {
  ...
  /// See also:
  ///
  ///  * [ExtendedScrollController.initialScrollOffset], which this overrides.
  @override
