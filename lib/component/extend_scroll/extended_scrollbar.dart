...
/// [Scrollbar] have been provided a unique [ExtendedScrollController]. Desktop
...
class RawScrollbar extends StatefulWidget {
  ...
  /// The [ExtendedScrollController] used to implement Scrollbar dragging.
  ///
...
class RawScrollbarState<T extends RawScrollbar> extends State<T> with TickerProviderStateMixin<T> {
  ...
  ExtendedScrollController? _cachedController;
  Timer? _fadeoutTimer;
  ...
  bool _debugCheckHasValidScrollPosition() {
    ...
    final ExtendedScrollController? scrollController = _effectiveScrollController;
