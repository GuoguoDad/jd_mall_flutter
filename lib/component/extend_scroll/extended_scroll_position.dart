...
export 'package:flutter/src/widgets/scroll_activity.dart' show ScrollHoldController;
...
abstract class ScrollPosition extends ViewportOffset with ScrollMetrics {
  ...
  Future<void> ensureVisible(
    ...
    double newTarget = target - (offsetTop ?? 0);
    ...
    return animateTo(newTarget, duration: duration, curve: curve);
  }
