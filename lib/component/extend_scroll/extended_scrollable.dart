...
import 'extended_scroll_position.dart';
import 'extended_scrollable_helpers.dart';
...
class ScrollableState extends State<Scrollable> with TickerProviderStateMixin, RestorationMixin implements ScrollContext {
  ...
  ExtendedScrollController get _effectiveScrollController => widget.controller ?? _fallbackScrollController!;
  ...
  void initState() {
    if (widget.controller == null) {
      _fallbackScrollController = ExtendedScrollController();
    }
    super.initState();
  }
