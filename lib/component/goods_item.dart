              ...
              ? Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(item.des1.toString(), style: TextStyle(color: '#ED4637'.toColor(), fontSize: 16)),
                    ),
                    Container(
                      margin: const EdgeInsets.only(top: 2),
                      padding: const EdgeInsets.only(left: 0, right: 6),
                      ...
                      child: Text(item.des2.toString(), style: TextStyle(color: '#737473'.toColor(), fontSize: 14)),
                    ),
                    Container(
                      margin: const EdgeInsets.only(top: 2),
                      padding: const EdgeInsets.only(left: 2, right: 2),
                      decoration: BoxDecoration(
                        color: '#FDF4F0'.toColor(),
                        borderRadius: const BorderRadius.all(Radius.circular(6)),
                      ),
                      child: Text("点击进入", style: TextStyle(color: '#ED4637'.toColor(), fontSize: 12)),
                    ),
                  ],
                )
              : Column(
                  children: [
                    Text(
                      ...
                      style: TextStyle(color: '#737473'.toColor(), fontSize: 14),
                    ),
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            ...
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                            style: TextStyle(color: '#ED4637'.toColor(), fontSize: 14),
                          ),
                          Container(
                            margin: const EdgeInsets.only(top: 2),
                            padding: const EdgeInsets.only(left: 2, right: 2),
                            ...
                            child: Text("看相似", style: TextStyle(color: '#A4A5A4'.toColor(), fontSize: 12)),
                          )
                        ],
                      ),
                    )
