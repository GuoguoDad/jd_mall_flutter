...
final categoryPageReducer = combineReducers<CategoryPageState>([
  //修改loading状态
  TypedReducer<CategoryPageState, SetLoadingAction>((state, action) => state..isLoading = action.value).call,
  //
  TypedReducer<CategoryPageState, ChangeTabClickAction>((state, action) => state..isTabClicked = action.value).call,
  //页面初始化数据
  TypedReducer<CategoryPageState, InitCategoryPageAction>((state, action) => state
    ...
    ..selectSecondCategoryInfo = action.selectSecondCategoryInfo).call,
  //选中一级分类
  TypedReducer<CategoryPageState, SelectCategoryAction>((state, action) => state..selectedCategoryInfo = action.selectedCategoryInfo).call,
  //选中二级分类
  TypedReducer<CategoryPageState, SelectSecondCategoryAction>((state, action) => state
    ...
    ..isTabClicked = action.isTabClicked ?? state.isTabClicked).call,
]);
